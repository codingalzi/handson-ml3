...
# 훈련셋에 특화되어 일반화 성능이 떨어지는 현상이 **과대 적합**<font size="2">overfitting</font>이다.
...
# [(구글코랩) 한눈에 보는 머신러닝](https://colab.research.google.com/github/codingalzi/handson-ml3/blob/master/notebooks/code_ml_landscape.ipynb)의 소스코드를 먼저 공부한 다음에
# [(실습) 한눈에 보는 머신러닝](https://colab.research.google.com/github/codingalzi/handson-ml3/blob/master/practices/practice_ml_landscape.ipynb)에 있는 실습 과제를 풀어보세요.
